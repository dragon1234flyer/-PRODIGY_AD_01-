...
class MainActivity : AppCompatActivity() {
    ...
    bbrac1.setOnClickListener {
                ...
                bsquare.setOnClickListener {
                    if(tvMain.text.toString().equals("000")){
                        Toast.makeText(this, "FUCK OFF BITCH", Toast.LENGTH_LONG).show()
                    }
                ...
                bequal.setOnClickListener {
                    ...
                    if (tvMain.text.toString().equals("69")){
                        Toast.makeText(this, "Naughty hora ke", Toast.LENGTH_SHORT).show()
                    }
                    tvMain.setText(remove(ans))
...
fun bcspcae(result: String):String{
    var value = result
